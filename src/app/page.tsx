  ...
  return (
    <div className='w-full h-full flex justify-center items-center relative bg-black text-white'>
      <div className='max-w-screen-xl w-full h-full flex relative'>
        ...
        <main className='ml-[275px] p-6 flex w-full max-w-2xl h-full min-h-screen flex-col border-l-[0.5px] border-r-[0.5px] 
        border-gray-600'>
          <h1 className='text-xl font-bold p-6 backdrop-blur bg-black/10 sticky top-0'>Home</h1>
          <div className='border-t-[0.5px] px-4 border-b-[0.5px] border-gray-600 relative flex items-stretch space-x-2
          py-4'>
